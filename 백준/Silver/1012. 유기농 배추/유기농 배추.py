...
전체 시간복잡도: 테스트 케이스 수 T에 대해 O(T×K). 최대 2500×50=125,000, 충분히 처리 가능.
3. 자료구조 :
배추밭 정보 (ground): M×N 크기의 2D 리스트로, 배추 위치를 1로 표시.
방문 체크 (check): M×N 크기의 2D 리스트로, 방문 여부를 True/False로 관리.
